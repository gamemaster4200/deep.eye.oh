...

{
  ...
  // trimmed, but the original bot-command case above preserves the raw
  // text verbatim (dispatch_command.py does its own trimming bot-side).
...
// ---------------------------------------------------------------------------
// formatStatusLine: renders only fields browser_farming.py's push_status()
// actually produces -- never an invented field (see push_status's caller
// in browser_farming.py's run_farming_loop).
// ---------------------------------------------------------------------------
